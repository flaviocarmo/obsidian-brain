...
- **Everything deterministic is code with tests.** 121 pytest tests, Windows-native, cp1252-console safe, pure stdlib.
...
```
python -m pytest -v      # 121 tests, Windows-native
```
...
- **Tudo que é determinístico é código com teste.** 121 testes pytest, Windows nativo, seguro em console cp1252, stdlib pura.
...
```
python -m pytest -v      # 121 testes, Windows nativo
```
