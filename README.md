...
- **Everything deterministic is code with tests.** 161 pytest tests, Windows-native, cp1252-console safe, pure stdlib.
...
```
python -m pytest -v      # 161 tests, Windows-native
```
...
- **Tudo que é determinístico é código com teste.** 161 testes pytest, Windows nativo, seguro em console cp1252, stdlib pura.
...
```
python -m pytest -v      # 161 testes, Windows nativo
```
